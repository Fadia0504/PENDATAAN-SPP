...
<?= $this->section('title') ?>Edit Data Guru<?= $this->endSection() ?>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="<?= base_url('guru/update/' . $guru['id']) ?>" method="post" enctype="multipart/form-data" id="formGuru">
                    <?= csrf_field() ?>
                        ...
                        <div class="col-md-12 text-center">
                            <div class="mb-3">
                                <?php if (!empty($guru['foto'])): ?>
                                    <img id="preview-foto" src="<?= base_url('uploads/foto_guru/' . $guru['foto']) ?>" 
                            ...
                            <small class="form-text text-muted">Format: JPG, JPEG, PNG. Maksimal 2MB. Kosongkan jika tidak ingin mengganti foto.</small>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="gelar" name="gelar" 
                                       placeholder="S.Pd, M.Pd, dll" value="<?= old('gelar', $guru['gelar']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= isset($errors['no_telepon']) ? 'is-invalid' : '' ?>" 
                                       id="no_telepon" name="no_telepon" value="<?= old('no_telepon', $guru['no_telepon']) ?>">
